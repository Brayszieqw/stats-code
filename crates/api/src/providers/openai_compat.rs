...
pub struct OpenAiCompatConfig {
    ...
    pub user_project_env: Option<&'static str>,
}
...
impl OpenAiCompatConfig {
    ...
    pub const fn gemini() -> Self {
        Self {
            ...
            user_project_env: Some("GEMINI_PROJECT_ID"),
        }
    }
...
impl OpenAiCompatClient {
    ...
    pub fn new(api_key: impl Into<String>, config: OpenAiCompatConfig) -> Self {
        Self {
            ...
            user_project: read_env_non_empty_opt(config.user_project_env),
    ...
    async fn send_raw_request(
        ...
        if let Some(user_project) = &self.user_project {
            request_builder = request_builder.header("x-goog-user-project", user_project);
        }
        request_builder
...
fn read_env_non_empty_opt(key: Option<&str>) -> Option<String> {
    key.and_then(|value| read_env_non_empty(value).ok().flatten())
}
